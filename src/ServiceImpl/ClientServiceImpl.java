...
public class ClientServiceImpl extends UtilisateurService {
	

	public ClientServiceImpl(UtilisateurDAO utilisateurDAO, RoleDAO roleDAO) {
	...
	public void inscription(Utilisateur utilisateur) {
		...
		Role role = this.roleDAO.findByNom(TypeRole.CLIENT).get();
